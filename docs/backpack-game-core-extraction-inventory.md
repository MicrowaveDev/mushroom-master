...
| asset/gacha/support services | Later ports after repository, payment, gacha, and support-operation policy contracts exist. | Provider SDKs/callbacks, SQL transactions, audit, support scopes, paid rollback, adult-content/payment policy. |

...
- Highest-value remaining server move lane:
  ...
  `battle-service.js`, `game-service.js`, and `player-service.js`. Move by
  `mv` into quarantined core ports first, then neutralize DB/catalog/policy
  access behind repositories and adapters.

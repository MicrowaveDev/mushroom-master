...
- game pointer commit: the `mushroom-master` commit that updates this file and
  the `vendor/backpack-game-core` pointer
...
| --- | --- | --- | --- | --- |
| 2026-07-02 | current pointer commit | `300583b` | Core changelog and package release notes | Documentation/package baseline only; runtime/API baseline remains `d5fb481`. |

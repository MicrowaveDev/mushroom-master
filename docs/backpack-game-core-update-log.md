...
- core SHA: `f9c00543ebc55ff4a409c2586514c2166859af36`
- core short SHA: `f9c0054`
- core commit: `Harden server modules and add reduced motion composable`
- runtime/API baseline: `f9c0054` (`Harden server modules and add reduced motion composable`)
- game pointer commit: `62b1f8a` (`Adopt server contract and reduced motion core`)

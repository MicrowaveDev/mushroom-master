...
- do not infer `.env` or neighboring repo env files for that queue item; the launcher must provide an explicit env file containing `OPENAI_API_KEY` for the CLI/API route;

...
- The 2026-06-29 run `codex-019f1482-8954-7b52-9f75-b377cf957645` proved that the sprite-box prompt still fails when the run only views the references before imagegen. Future runs need actual imagegen input binding for the checked-in PNGs; `view_image` plus text prompt references is still text-only-equivalent for this gate.

...
Step 3: Battle Replay (auto-shown after ready)
  ...
  Sees (while replay plays):
    ...
    - Active speech bubble is anchored over the speaking fighter's portrait and reads as character speech, not a detached caption. It must not cover the configured face/head anchor for that portrait variant.

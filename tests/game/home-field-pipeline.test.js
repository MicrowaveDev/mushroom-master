...
const scriptPath = path.join(repoRoot, 'app/scripts/generation/produce-home-field-assets.js');
const familyProducerScriptPath = path.join(repoRoot, 'app/scripts/generation/produce-home-field-family.js');
const grassFamilySheetScriptPath = path.join(repoRoot, 'app/scripts/generation/generate-home-field-grass-family-sheet.js');
const alphaSheetScriptPath = path.join(repoRoot, 'app/scripts/generation/generate-home-field-alpha-sheet.js');
const mobileReadabilitySheetScriptPath = path.join(repoRoot, 'app/scripts/generation/generate-home-field-mobile-readability-sheet.js');
const candidateEvidenceScriptPath = path.join(repoRoot, 'app/scripts/generation/generate-home-field-candidate-evidence.js');
const validateScriptPath = path.join(repoRoot, 'app/scripts/checks/validate-home-field-assets.js');
const nextScriptPath = path.join(repoRoot, 'app/scripts/generation/next-home-field-image-prompts.js');
...
const claimImagegenOutputScriptPath = path.join(repoRoot, 'app/scripts/workflows/claim-home-field-imagegen-output.js');
const archiveChibiProofScriptPath = path.join(repoRoot, 'app/scripts/workflows/archive-home-field-chibi-proof.js');
const recoverChibiAlphaScriptPath = path.join(repoRoot, 'app/scripts/workflows/recover-home-field-chibi-alpha.js');
const recordChibiVerdictScriptPath = path.join(repoRoot, 'app/scripts/workflows/record-home-field-chibi-verdict.js');
const chibiPreflightScriptPath = path.join(repoRoot, 'app/scripts/checks/preflight-home-field-chibi-proof.js');
const chibiReferenceApiProofScriptPath = path.join(repoRoot, 'app/scripts/workflows/run-home-field-chibi-reference-api-proof.js');
const chibiStageLocalSourceScriptPath = path.join(repoRoot, 'app/scripts/workflows/stage-home-field-chibi-local-source.js');
const chibiVerifyScriptPath = path.join(repoRoot, 'app/scripts/checks/verify-home-field-chibi-proof-files.js');
const generationQueueScriptPath = path.join(repoRoot, 'app/scripts/workflows/print-home-field-generation-queue.js');
const chibiSplitScriptPath = path.join(repoRoot, 'app/scripts/workflows/split-home-field-chibi-state-sheet.js');
const paletteAuditScriptPath = path.join(repoRoot, 'app/scripts/checks/audit-home-field-chibi-palette.js');
...
test('[home-field] package exposes chibi proof helper aliases', () => {
  ...
  assert.equal(pkg.scripts['game:home-field:claim-imagegen-output'], 'node app/scripts/workflows/claim-home-field-imagegen-output.js');
  assert.equal(pkg.scripts['game:home-field:archive-stale-chibi-proof'], 'node app/scripts/workflows/archive-home-field-chibi-proof.js');
  assert.equal(pkg.scripts['game:home-field:chibi-reference-api-proof'], 'node app/scripts/workflows/run-home-field-chibi-reference-api-proof.js');
  assert.equal(pkg.scripts['game:home-field:stage-chibi-local-source'], 'node app/scripts/workflows/stage-home-field-chibi-local-source.js');
  assert.equal(pkg.scripts['game:home-field:generation-queue'], 'node app/scripts/workflows/print-home-field-generation-queue.js');
  assert.equal(pkg.scripts['game:home-field:recover-chibi-alpha'], 'node app/scripts/workflows/recover-home-field-chibi-alpha.js');
  assert.equal(pkg.scripts['game:home-field:record-chibi-verdict'], 'node app/scripts/workflows/record-home-field-chibi-verdict.js');

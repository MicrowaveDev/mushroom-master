...
test('challenge mode: invite → accept → readies → round resolves → UI screenshots', async ({ page, request, baseURL }) => {
  ...
  await page.goto(`${baseURL}?screen=prep`, { waitUntil: 'networkidle' });
  ...
  await pageB.goto(`${baseURL}?screen=prep`, { waitUntil: 'networkidle' });
  ...
  await page.goto(`${baseURL}?screen=runComplete`, { waitUntil: 'networkidle' });

        ...
        content: [
          {
            ...
            text: [
              ...
              '- Не дублируй одно и то же содержание между подразделами. Каждый подраздел должен содержать уникальную информацию. Обзор — кто персонаж и его суть. Мотивы и роль — его психология, цели и функция в группе. Не повторяй описание темы и стиля боя из Обзора в Мотивах.',

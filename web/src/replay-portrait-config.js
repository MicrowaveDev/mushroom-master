...
export const replayPortraitConfigByMushroom = {
  thalla: {
    ...
    1: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '44%', imagePosition: '50% 30%', faceBottom: 55 }),
  ...
  lomie: {
    ...
    1: portraitLayout({ insetLeft: '18px', insetRight: '20px', tailLeft: '54%', imagePosition: '50% 28%', faceBottom: 55 }),
    2: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '50%', imagePosition: '50% 22%', faceBottom: 48 })
  },
  axilin: {
    default: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '52%', imagePosition: '50% 8%' }),
    1: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '48%', imagePosition: '50% 24%', faceBottom: 55 }),
  ...
  kirt: {
    ...
    1: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '50%', imagePosition: '50% 28%', faceBottom: 55 })
  },
  morga: {
  ...
  dalamar: {
    ...
    1: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '48%', imagePosition: '50% 28%', faceBottom: 55 }),
    2: portraitLayout({ insetLeft: '18px', insetRight: '18px', tailLeft: '52%', imagePosition: '50% 2%', headY: 36 })
  }
};

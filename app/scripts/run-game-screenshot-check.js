...
async function main() {
  ...
  console.log(`[game:test:screens] backend port ${backendPort}`);
  console.log(`[game:test:screens] frontend port ${frontendPort}`);
  if (args.debug) {
    console.log('[game:test:screens] debug logs enabled');
  }

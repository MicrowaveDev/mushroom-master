...
function chibiLocalSourceDetails(asset) {
  ...
  return [
    ...opening,
    'Treat docs/reference/home-field/chibi-thalla-previous-best-2026-06-26-state-sheet.png, docs/reference/home-field/chibi-thalla-liked-2026-06-23.png, and docs/reference/home-field/chibi-style-agent-log-reference.png as styleReferences for visual review only. The liked Thalla reference is the primary positive style target for the next source\'s youthful little-girl face/body read: rounded cheeks, sweet simple expression, tiny childlike body, and soft hand-drawn field-sprite charm. They are not proof sources and must not be attached to imagegen in this run.',
    ...
    'Mechanical sheet success, alpha success, mobile readability, and chibi-quality validation do not count as style approval. The composed preview must match the hand-drawn elevated 2.5D field-sprite target and must read as youthful little-girl Thalla like the positive references, not old monk, beige mascot pawn, elderly gnome, or faceless mushroom token. If the supplied source fails the visual gate, record the verdict and require a new supplied complete local source or an intentional future method change; do not silently fall back to imagegen.'
  ].join(' ');
}
...
function chibiReferenceTurnaroundPromptBlock(asset, { chibiCandidate = false, showFallbacks = false } = {}) {
  ...
  if (isThallaChibiLocalSourceCandidate(asset, { chibiCandidate }) && !showFallbacks) {
    return [
      ...
      '- `docs/reference/home-field/chibi-thalla-liked-2026-06-23.png` - primary positive youthful little-girl Thalla face, cap, robe, rounded-cheek appeal, and soft hand-drawn charm; simplify heavily.',
  ...
  return [
    ...
    '- `docs/reference/home-field/chibi-thalla-liked-2026-06-23.png` — primary positive youthful little-girl Thalla face/cap/robe appeal; simplify heavily.',

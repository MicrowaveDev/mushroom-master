...
function chibiLocalSourceDetails(asset) {
  ...
  return [
    ...opening,
    'Treat docs/reference/home-field/chibi-thalla-previous-best-2026-06-26-state-sheet.png, docs/reference/home-field/chibi-thalla-liked-2026-06-23.png, and docs/reference/home-field/chibi-style-agent-log-reference.png as styleReferences for visual review only. The liked Thalla reference is the primary positive style target for the next source\'s youthful little-girl face/body read: rounded cheeks, sweet simple expression, compact visible oval/almond doll eyes, tiny childlike body, and soft hand-drawn field-sprite charm. They are not proof sources and must not be attached to imagegen in this run.',
...
function chibiReferenceTurnaroundPromptBlock(asset, { chibiCandidate = false, showFallbacks = false } = {}) {
  ...
  if (isThallaChibiLocalSourceCandidate(asset, { chibiCandidate }) && !showFallbacks) {
    return [
      ...
      '- `docs/reference/home-field/chibi-thalla-liked-2026-06-23.png` - primary positive youthful little-girl Thalla face, cap, robe, compact oval/almond doll eyes, rounded-cheek appeal, and soft hand-drawn charm; simplify heavily.',
  ...
  return [
    ...
    '- `docs/reference/home-field/chibi-thalla-liked-2026-06-23.png` — primary positive youthful little-girl Thalla face/cap/robe appeal with compact visible oval/almond doll eyes; simplify heavily.',
    ...
    '',
    'Input images: use the attached checked-in reference images as guidance. Preserve the compact sprite proportions and charm of the previous-best state sheet as the primary layout/scale authority, use the liked Thalla image for simplified cute little-girl face/cap/robe appeal with compact visible oval/almond doll eyes, and use the chibi style reference only for field-sprite scale/outline simplicity.',
    '',

...
Examples:
  app/scripts/operations/restart-production-server.sh
  app/scripts/operations/restart-production-server.sh --build
  app/scripts/operations/restart-production-server.sh --pull --build --logs
  app/scripts/operations/restart-production-server.sh --all
  app/scripts/operations/restart-production-server.sh --env-file .env.production

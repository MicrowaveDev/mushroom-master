...
| **rerun-path-family** | `npm run game:home-field:rerun-path-family` | Candidate-safe path-family rerun for `path_h_end_w`, `path_dirt_straight`, `path_spore_glow`, `path_h_end_e`, and `path_destination_row`. |

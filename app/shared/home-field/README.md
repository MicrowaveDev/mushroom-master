...
- **Chibi rows misordered**: row order is locked to `down, up, left, right` top to bottom. The validator enforces this. Idle frames are columns 0-1 and must be a non-duplicated normal-to-tiny-squat pair; walk frames per row are columns 2-7.
